...
**⭐Overview:**
Analyzed e-commerce user data to identify key predictors of income and churn. Conducted rigorous A/B testing on numerical and NLP features to determine their impact on user behavior.
